...
```powershell
python experiments/train_shared_ppo.py --config configs/shared_ppo_2p_1m.yaml --run-dir runs/shared_ppo_2p_1m_seed42 --resume runs/shared_ppo_2p_1m_seed42/checkpoints/step_000114688.pt --device cuda
